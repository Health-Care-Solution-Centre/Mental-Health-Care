...
<head>
    ...
    <style>
    body{
        background-image: url('icons&images/pastel_colors-wallpaper-1680x1050.jpg');
	...
	<title>Mental Quiz | Mental Health check</title>
            ...
            <ol>
                ...
                <li>
                    ...
                    <div>
                        ...
                        <label for="question-2-answers-C">C) More than half the days
</label>
                    </div>
