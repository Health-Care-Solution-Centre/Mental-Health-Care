...
?>-->
  ...
  <body>
    <form action="expert_update_profile.php" method="post" enctype="multipart/form-data">
      <table class="table table-bordered">
		...
		<tr>
          <td>Password</tD>
          <td><input type="text" value="<?php echo $r ['expert_password']; ?>" name="p" readonly="readonly"></td>
        </tR>
        
        <tr>
          <td>Mobile</tD>
          <td><input type="text" value="<?php echo $r ['mobile']; ?>" name="mobile" readonly="readonly"></td>
        </tR>
        <tr>
          <td>Address</tD>
          <td><input type="text" value="<?php echo $r ['address']; ?>" name="adds" readonly="readonly"></td>
        </tR>
        
         <tr>
          <td>Education</tD>
          <td><input type="text" value="<?php echo $r ['expert_education']; ?>" name="education" readonly></td>
        </tR>
        
        <tr>
      <td align="center" colspan="2">
        <input type="submit" name="save" value="Edit Profile"/>
        </td>
        </tR>
      </table>
    </form>
